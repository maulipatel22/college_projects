...
class WPM_Game:
    ...
    def __init__(self):
        ...
        self.wpm = 0
        self.end = False
        self.HEAD_C = (255, 127, 0)
        self.TEXT_C = (240, 240, 240)
        self.RESULT_C = (255, 70, 70)

        pygame.init()
        self.open_img = pygame.image.load('welcome_page.png')
    ...
    def show_results(self, screen):
        if (not self.end):
            ...
            screen.blit(self.time_img, (self.w / 2 - 50, self.h - 200))
            self.draw_text(screen, "Reset", self.h - 150, 26, (100, 100, 100))
